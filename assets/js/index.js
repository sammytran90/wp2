            ...
            slides: [
                [
                    ...
                    },
                    {
                        content: [
                            [
                                '<i>“Energy is the new currency of</i>',
                                '<i>the future,” - Participant.</i>'
                            ]
                        ]
                    },
                    {
                        content: [
                            [
                                '<i>“Everybody will get</i>',
                                '<i>energy-producing-duty,”</i>',
                                '<i>- Participant.</i>'
                            ]
                        ]
                    },
                    {
                        content: [
                            [
                                '<i>“We need more examples</i>',
                                '<i>of possible solutions;</i>',
                                '<i>show it and it can</i>',
                                '<i>happen!”</i>'
                            ]
                        ]
                    },
